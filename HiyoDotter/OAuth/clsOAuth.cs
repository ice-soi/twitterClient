...
namespace HiyoDotter.Logic
{
    class clsOAuth
    {
        const string REQUEST_APP_TOKEN_URL = "https://api.twitter.com/oauth2/token";
        ...
        const string CONSUMER_KEY = "xxxxxxxxxxxxxx";
        const string CONSUMER_SECRET = "xxxxxxxxxxxxxx";
        ...
        public clsOAuth(string accessToken, string accessTokenSecret, string userId, string screenName)
        {
            ServicePointManager.Expect100Continue = false;
            ConsumerKey = CONSUMER_KEY;
            ConsumerSecret = CONSUMER_SECRET;
